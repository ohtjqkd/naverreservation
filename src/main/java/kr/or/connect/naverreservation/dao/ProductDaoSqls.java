...
public class ProductDaoSqls {
	...
	//displayInfo sqls//
	static final String SELECT_DISPLAY_INFO = "SELECT * FROM display_info INNER JOIN product ON product.id = display_info.product_id INNER JOIN category ON category.id = product.category_id WHERE display_info.id = :displayInfoId";
