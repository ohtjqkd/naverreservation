                    ...
                    <ul class="lst_event_box">
                        <li class="item">
                            <a href="detail.html" class="item_book">
                                ...
                                <div class="event_txt">
                                    <h5 class="event_txt_tit"> <span>뮤지컬 드림걸즈(DREAMGIRLS) 최초 내한</span> <small class="sm">샤롯데 씨어터</small> </h5>
                        ...
                        <li class="item">
                            <a href="detail.html" class="item_book">
                                ...
                                <div class="event_txt">
                                    <h5 class="event_txt_tit"> <span>뮤지컬 더 데빌 The DEVIL</span> <small class="sm">드림아트센터 1관 에스비타운</small> </h5>
                    ...
                    <ul class="lst_event_box">
                        <li class="item">
                            <a href="detail.html" class="item_book">
                                ...
                                <div class="event_txt">
                                    <h5 class="event_txt_tit"> <span>뮤지컬 로미오와 줄리엣</span> <small class="sm">종로구 두산아트센터 연강홀</small> </h5>
                        ...
                        <li class="item">
                            <a href="detail.html" class="item_book">
                                ...
                                <div class="event_txt">
                                    <h5 class="event_txt_tit"> <span>뮤지컬 인 더 하이츠(IN THE HEIGHTS)</span> <small class="sm">예술의전당 CJ토월극장</small> </h5>
    ...
    <script type="rv-template" id="itemList">
        <li class="item">
            <a href="detail?displayInfoId={{displayInfoId}}" class="item_book">
                ...
                <div class="event_txt">
                    <h5 class="event_txt_tit"> <span>{{productDescription}}</span> <small class="sm">{{placeName}}</small> </h5>
