            ...
            <div class="ct_wrap">
                ...
                <div class="group_visual">
                    <div class="container_visual">
                        <ul class="visual_img">
                            <li class="item"> <img alt="${displayInfoResponse.displayInfo.description}" class="img_thumb" src="${displayInfoResponse.productImages[0].saveFileName}"/> <span class="img_bg"></span>
                ...
                <div class="section_store_details">
                    <div class="store_details">
                        <h3 class="in_tit"></h3>
                        <p class="dsc">
	                            장소 : ${displayInfoResponse.displayInfo.placeName}<br> 기간 :
                        </p>
                        <h3 class="in_tit">관람시간</h3>
                        <p class="dsc">
                            ${displayInfoResponse.displayInfo.openingHours }
                        </p>
...
<!--                         <div class="qty">
                            ...
                            <div class="count_control">
                                ...
                                <div class="clearfix">
                                    <button class="btn_plus_minus spr_book2 ico_minus3" title="빼기">&ndash;</button><input type="tel" class="count_control_input" value="0" readonly title="수량"><button class="btn_plus_minus spr_book2 ico_plus3" title="더하기">+</button>                                    
                                </div>
                        ...
                        <div class="qty">
                            ...
                            <div class="count_control">
                                <div class="clearfix">
                                    <button class="btn_plus_minus spr_book2 ico_minus3 disabled" title="빼기"></button><input type="tel" class="count_control_input" readonly title="수량"><button class="btn_plus_minus spr_book2 ico_plus3" title="더하기"></button>                                    
                                </div>
                        ...
                        <div class="qty">
                            ...
                            <div class="count_control">
                                <div class="clearfix">
                                    <button class="btn_plus_minus spr_book2 ico_minus3 disabled" title="빼기"></button><input type="tel" class="count_control_input" value="3" readonly title="수량"><button class="btn_plus_minus spr_book2 ico_plus3" title="더하기"></button>
                                </div>
 ...
 -->                
                ...
                <div class="section_booking_form">
                    <div class="booking_form_wrap">
                        <div class="form_wrap">
                            ...
                            <div class="agreement_nessasary help_txt"> <span class="spr_book ico_nessasary"><img src="img/nessasary_chk.png"/></span> <span>필수입력</span> </div>
                            <form class="form_horizontal">
                                <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary"><img src="img/nessasary_chk.png"/></span> <span>예매자</span> </label>
                                    <div class="inline_control"> <input type="text" name="name" id="name" class="text" placeholder="이름을 입력해주세요." maxlength="17"> </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary"><img src="img/nessasary_chk.png"/></span> <span>연락처</span> </label>
                                    <div class="inline_control tel_wrap">
                                        <input type="tel" name="tel" id="tel" class="tel" value="" placeholder="휴대폰 입력 시 예매내역 문자발송">
                                        <div class="warning_msg hide">형식이 틀렸거나 너무 짧아요</div>
                                    </div>
                                </div>
                                <div class="inline_form"> <label class="label" for="email">  <span class="spr_book ico_nessasary"><img src="img/nessasary_chk.png"/></span>  <span>이메일</span> </label>
                                    <div class="inline_control"> <input type="email" name="email" id="email" class="email" value="" placeholder="id@naver.com" maxlength="50"> </div>
                                </div>
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected">${reserveDate }, 총 <span id="totalCount">0</span>매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="section_booking_agreement">
                        ...
                        <div class="agreement"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span> </span>
                            <span class="btn_agreement"> <span class="btn_text">보기</span> <i class="fn fn-down2"></i></span>
                ...
                <div class="box_bk_btn">
                    ...
                    <div class="bk_btn_wrap disable"> <button type="button" class="bk_btn disable" disabled="disabled"> <i class="spr_book ico_naver_s"></i>  <span>예약하기</span> </button> </div>
                </div>
            </div>
        </div>
    </div>
